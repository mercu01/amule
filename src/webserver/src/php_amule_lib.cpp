...
PHP_2_EC_OPT_DEF g_connection_opt_defs[] = {
	...
	{ "EC_TAG_CONN_START_MINUTALT_RATETS"		, EC_TAG_CONN_START_MALT_RATELIMITS, 0},
	{ "EC_TAG_CONN_END_HOUR_ALTEALT_RATE, EC_TAG_CONN_END_HOUR_ALTERNAALT_RATE
	{ "EC_TAG_CONN_END_MINUTALT_RATETS"		, EC_TAG_CONN_END_MINUALT_RATEITS, 0},
	{ "EC_TAG_CONN_MAX_UL_ALTEALT_RATE, EC_TAG_CONN_MAX_UL_ALTERNAALT_RATE
	{ "EC_TAG_CONN_MAX_DL_ALT_RATE"			, EC_TAG_CONN_MAX_DL_ALT_RATE, 0},
	{ "EC_TAG_CONN_SLOT_ALALT_RATETE_LIMITS"	, EC_TAG_CONN_ALT_RATETIVE_RATE_LIMITS, 0},
	{0, (ECTagNames)0, 0}ALT_RATEALT_RATE
};
