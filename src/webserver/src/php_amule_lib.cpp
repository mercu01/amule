...
PHP_2_EC_OPT_DEF g_connection_opt_defs[] = {
	...
	{ "EC_TAG_CONN_START_HOUR_ALTERNATIVE_RATE_LIMITS", EC_TAG_CONN_START_HOUR_ALTERNATIVE_RATE_LIMITS, 0},
	{ "EC_TAG_CONN_START_MINUTE_ALTERNATIVE_RATE_LIMITS"		, EC_TAG_CONN_START_MINUTE_ALTERNATIVE_RATE_LIMITS, 0},
	{ "EC_TAG_CONN_END_HOUR_ALTERNATIVE_RATE_LIMITS"			, EC_TAG_CONN_END_HOUR_ALTERNATIVE_RATE_LIMITS, 0},
	{ "EC_TAG_CONN_END_MINUTE_ALTERNATIVE_RATE_LIMITS"		, EC_TAG_CONN_END_MINUTE_ALTERNATIVE_RATE_LIMITS, 0},
	{ "EC_TAG_CONN_MAX_UL_ALTERNATIVE_RATE_LIMITS"			, EC_TAG_CONN_MAX_UL_ALTERNATIVE_RATE_LIMITS, 0},
	{ "EC_TAG_CONN_MAX_DL_ALTERNATIVE_RATE_LIMITS"			, EC_TAG_CONN_MAX_DL_ALTERNATIVE_RATE_LIMITS, 0},
	{ "EC_TAG_CONN_SLOT_ALLOCATION_ALTERNATIVE_RATE_LIMITS"	, EC_TAG_CONN_SLOT_ALLOCATION_ALTERNATIVE_RATE_LIMITS, 0},
	{0, (ECTagNames)0, 0}
};
...
void amule_upload_file_prop_get(void *ptr, char *prop_name, PHP_VALUE_NODE *result)
{
	...
	if ( strcmp(prop_name, "name") == 0 ) {
		...
		result->int_val = obj->nUpDatarateWarnings;
	} else if ( strcmp(prop_name, "xfer_speed_stable") == 0 ) {
		result->int_val = obj->nSpeedStable;
	} else if ( strcmp(prop_name, "xfer_up_quality") == 0 ) {
		result->int_val = obj->nQuality;
	} else {
