...
enum ECTagNames {
	...
	EC_TAG_CLIENT                             = 0x0600,
		...
		EC_TAG_CLIENT_UP_SPEED_STABLE             = 0x0632
		EC_TAG_CLIENT_UP_SPEED_WARNINGS           = 0x0631,
		EC_TAG_CLIENT_UP_SPEED_QUALITY            = 0x0633,
	...
	EC_TAG_SELECT_PREFS                       = 0x1000,
		...
		EC_TAG_PREFS_CONNECTIONS                  = 0x1300,
			...
			EC_TAG_CONN_START_HOUR_ALTERNATIVE_RATE_LIMITS       = 0x1310,
			EC_TAG_CONN_START_MINUTE_ALTERNATIVE_RATE_LIMITS     = 0x1311,
			EC_TAG_CONN_END_HOUR_ALTERNATIVE_RATE_LIMITS         = 0x1312,
			EC_TAG_CONN_END_MINUTE_ALTERNATIVE_RATE_LIMITS       = 0x1313,
			EC_TAG_CONN_MAX_UL_ALTERNATIVE_RATE_LIMITS           = 0x1314,
			EC_TAG_CONN_MAX_DL_ALTERNATIVE_RATE_LIMITS           = 0x1315,
			EC_TAG_CONN_SLOT_ALLOCATION_ALTERNATIVE_RATE_LIMITS  = 0x1316,
...
wxString GetDebugNameECTagNames(uint16 arg)
{
	switch (arg) {
		...
		case 0x0632: return wxT("EC_TAG_CLIENT_UP_SPEED_STABLE");
		case 0x0631: return wxT("EC_TAG_CLIENT_UP_SPEED_WARNINGS");
		case 0x0633: return wxT("EC_TAG_CLIENT_UP_SPEED_QUALITY");
		...
		case 0x1310: return wxT("EC_TAG_CONN_START_HOUR_ALTERNATIVE_RATE_LIMITS");
		case 0x1311: return wxT("EC_TAG_CONN_START_MINUTE_ALTERNATIVE_RATE_LIMITS");
		case 0x1312: return wxT("EC_TAG_CONN_END_HOUR_ALTERNATIVE_RATE_LIMITS");
		case 0x1313: return wxT("EC_TAG_CONN_END_MINUTE_ALTERNATIVE_RATE_LIMITS");
		case 0x1314: return wxT("EC_TAG_CONN_MAX_UL_ALTERNATIVE_RATE_LIMITS");
		case 0x1315: return wxT("EC_TAG_CONN_MAX_DL_ALTERNATIVE_RATE_LIMITS");
		case 0x1316: return wxT("EC_TAG_CONN_SLOT_ALLOCATION_ALTERNATIVE_RATE_LIMITS");
