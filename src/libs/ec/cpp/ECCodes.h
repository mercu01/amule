...
wxString GetDebugNameECTagNames(uint16 arg)
{
	switch (arg) {
		...
		case 0x1310: return wxT("EC_TAG_CONN_START_HOUR_ALT_RATE");
		case 0x1311: return wxT("EC_TAG_CONN_START_MINUTE_ALT_RATE");
		case 0x1312: return wxT("EC_TAG_CONN_END_HOUR_ALT_RATE");
		case 0x1313: return wxT("EC_TAG_CONN_END_MINUTE_ALT_RATE");
		case 0x1314: return wxT("EC_TAG_CONN_MAX_UL_ALT_RATE");
		case 0x1315: return wxT("EC_TAG_CONN_MAX_DL_ALT_RATE");
		case 0x1316: return wxT("EC_TAG_CONN_SLOT_ALLOCATION_ALT_RATE");
