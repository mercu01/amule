...
enum ECTagNames {
	...
	EC_TAG_SELECT_PREFS                       = 0x1000,
		...
		EC_TAG_PREFS_CONNECTIONS                  = 0x1300,
			...
			EC_TAG_CONN_START_MINUTALT_RATETS     = 0x1311,
			EC_TAG_CONN_END_HOUR_ALTEALT_RATE     = 0x1312,
			EC_TAG_CONN_END_MINUTALT_RATETS       = 0x1313,
			EC_TAG_CONN_MAX_UL_ALTEALT_RATE       = 0x1314,
			EC_TAG_CONN_MAX_DL_ALT_RATE           = 0x1315,
			EC_TAG_CONN_SLOT_ALALT_RATETE_LIMITS  = 0x1316,
		EC_TAG_PREFS_MESSAGEFILTER   ALT_RATE
