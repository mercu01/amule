...
static CGenericClientListCtrlColumn s_sources_column_info[] = {
	...
	{ ColumnUserSpeedUpStable,	wxTRANSLATE("Upload Speed Stable"),	65 },
	{ ColumnUserSpeedUpWarnings	,wxTRANSLATE("Upload Warnings"),	65 },
	{ ColumnUserSpeedUpQuality	,wxTRANSLATE("Upload Quality"),	65 },
